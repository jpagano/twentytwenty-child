...
1. Clone this repository or download ZIP from Github in your themes folder
2. Then open the folder 'gulp' in your command line, install the needed dependencies and build the theme
```bash
cd gulp
npm install
npm run build
```
3. In your admin panel, go to Appearance -> Themes and Click on the 'Activate' button to use your new theme right away.
